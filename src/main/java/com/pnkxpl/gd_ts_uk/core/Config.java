...
public class Config {
  ...
  public static final ModConfigSpec.ConfigValue< List< ? extends Boolean > > ENABLE_DEBUG_LOGS__ENABLE_INFO_LOGS__ENABLE_WARN_LOGS__ENABLE_ERROR_LOGS = bui读设件ζif亮Z烧怪
      ...
      .defineList( "( ENABLE_DEBUG_LOGS, ENABLE_INFO_LOGS, ENABLE_WARN_LOGS, ENABLE_ERROR_LOGS )", Arrays.asList( false, false, false, true ), o -> o instanceof Boolean );
  ...
  //!defineList(不能打.)
  public static final ModConfigSpec.ConfigValue< List< ? extends String > > 设ζ启ζif亮Z烧怪 = bui读设件ζif亮Z烧怪.defineList( "设ζ启", Arrays.asList( "1" ), o -> o instanceof String );
  ...
  public static final ModConfigSpec.ConfigValue< List< ? extends Integer > > 设ζt隔ζ检ent__检rY__检rX__检rZ = bui读设件ζif亮Z烧怪
      /// 20, 32, 64, 64
      .defineList( "( t隔ζ检ent, 检rY, 检rX, 检rZ乘 )", Arrays.asList( 15, 16, 16, 16 ), o -> o instanceof Integer );
  //!跳同tpA跳
  public static final ModConfigSpec.Builder 分段2 = bui读设件ζif亮Z烧怪.pop( ).push( "跳 =tpA跳    jump =(tp ~ ~1 ~)andJump" );
  public static final ModConfigSpec.ConfigValue< List< ? extends String > > 设ζ启ζ跳同tpA跳 = bui读设件ζif亮Z烧怪.defineList( "设ζ启", Arrays.asList( "1" ), o -> o instanceof String );
  public static final ModConfigSpec.ConfigValue< List< ? extends String > > 设ζ跳同tpA跳ζtp坐加 = bui读设件ζif亮Z烧怪.defineList( "(tp ~<x> ~<y> ~<z>)の( y, x, z )", Arrays.asList( "1", "0", "0" ), o -> o instanceof String );
  //!放块在块前
  public static final ModConfigSpec.Builder 分段3 = bui读设件ζif亮Z烧怪.pop( ).push( "放块在块前    placeFront " );
  public static final ModConfigSpec.ConfigValue< List< ? extends String > > 设ζ启ζ放块在块前 = bui读设件ζif亮Z烧怪.defineList( "设ζ启", Arrays.asList( "1" ), o -> o instanceof String );
  public static final ModConfigSpec.ConfigValue< List< ? extends Integer > > 设ζ多选ζ放块在块の向 = bui读设件ζif亮Z烧怪
      ...
      .defineList( "( 5元 )", Arrays.asList( 1, 1, 1, 1, 1 ), o -> o instanceof Integer );
  public static final ModConfigSpec.ConfigValue< ? extends List< ? extends String > > 设ζif坐差小这Z触 = bui读设件ζif亮Z烧怪
      .defineList( "( if坐差小这Z触ζy, if坐差小这Z触ζxz )", Arrays.asList( "1.0", "1.2" ), o -> o instanceof String );/*2026年3月1日00时17分09*/
  //!attribute
  public static final ModConfigSpec.Builder 分段ζattribute = bui读设件ζif亮Z烧怪.pop( ).push( "attribute" );
  public static final ModConfigSpec.ConfigValue< List< ? extends String > > 设ζ启ζattribute = bui读设件ζif亮Z烧怪.defineList( "设ζ启", Arrays.asList( "1" ), o -> o instanceof String );
  public static final ModConfigSpec.ConfigValue< List< ? extends String > > 设ζattributeζt隔 = bui读设件ζif亮Z烧怪.defineList( "t隔", Arrays.asList( "50" ), o -> o instanceof String );
  public static final ModConfigSpec.ConfigValue< List< ? extends Integer > > 设ζattributeζ启 = bui读设件ζif亮Z烧怪
      .defineList( "启( hp, walkSpeed, flySpeed, stepHight, (5)attackSpeed, sweep )", Arrays.asList( 1, 1, 1, 1, 0, 1 ), o -> o instanceof Integer );
  ...
  public static final ModConfigSpec.ConfigValue< ? extends List< ? extends String > > 设ζattribute = bui读设件ζif亮Z烧怪.defineList( "值( hp, walkSpeed, flySpeed, stepHight, (5)attackSpeed, sweep )", Arrays.asList( "100", "0.1", "0.15", "1.0", "4", "1" ), o -> o instanceof String );
  public static final ModConfigSpec.ConfigValue< ? extends List< ? extends String > > 跑时walkSpeed乘 = bui读设件ζif亮Z烧怪.defineList( "跑时walkSpeed乘", Arrays.asList( "3" ), o -> o instanceof String );
  public static final ModConfigSpec.ConfigValue< ? extends List< ? extends String > > 跑时flySpeed乘 = bui读设件ζif亮Z烧怪.defineList( "跑时flySpeed乘", Arrays.asList( "3" ), o -> o instanceof String );
  //!if有饥Z(hp加)
  public static final ModConfigSpec.Builder 分段ζc_if有饥饿值Z回血 = bui读设件ζif亮Z烧怪.pop( ).push( "if有饥Z(hp加)" );
  public static final ModConfigSpec.ConfigValue< List< ? extends String > > 设ζ启ζc_if有饥饿值Z回血 = bui读设件ζif亮Z烧怪.defineList( "设ζ启", Arrays.asList( "1" ), o -> o instanceof String );
  public static final ModConfigSpec.IntValue 设ζc_if有饥饿值Z回血ζt隔 = bui读设件ζif亮Z烧怪.defineInRange( "t隔", 100, 0, 15000 );
  ...
  public static final ModConfigSpec.ConfigValue< ? extends List< ? extends String > > 设ζFovModifier = bui读设件ζif亮Z烧怪
      .defineList( "FovModifier", Arrays.asList( "1.3" ), o -> o instanceof String );
